...
Installation
============
To install arcadeVFE 1.2.2.1, follow these four steps:
1. Download the Windows installer from the [Releases](https://github.com/gildahl/arcadeVFE/releases/tag/v1.2.2.1) page.
